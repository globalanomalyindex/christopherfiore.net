...
function paintBackdrop(stage: HTMLElement): void {
  ...
  const top =
    qq(stage, '[data-chellbook],[data-evidence],[data-about],[data-df2tm],[data-mfny],[data-chipotle]').find(shown) ??
...
function syncPageA11y(stage: HTMLElement): void {
  ...
  for (const sub of qq(stage, '[data-chellbook],[data-evidence],[data-about],[data-df2tm],[data-mfny],[data-chipotle]')) {
