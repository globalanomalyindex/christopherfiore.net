  ...
  return el(
    'div',
    {
      ...
      style: css({
        ...
        border: `1px solid ${RULE.onLavenderMajor}`,
  ...
  return el(
    'a',
    {
      ...
      style: css({
        ...
        'align-items': 'center',
        'border-top': `2px solid ${COLOR.rust}`,
        background: rgba(COLOR.shadowRust, 0.07),
      }),
    },
    label,
    filmstrip(),
  ...
  const close = el(
    'button',
    {
      ...
      style: css({
        ...
        gap: 16,
        'padding-left': MODULE,
        'border-right': `1px solid ${RULE.onLavenderMinor}`,
    ...
    el(
      'span',
      {
        style: css({
          ...
          'align-items': 'center',
          padding: '0 20px',
          'border-right': rule ? `1px solid ${RULE.onLavenderMinor}` : null,
        }),
      },
      text,
    );
